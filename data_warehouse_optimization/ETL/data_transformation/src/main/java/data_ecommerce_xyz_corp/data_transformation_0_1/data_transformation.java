...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ky23w0efS2DDAdLDo7t8imuEyGjcpV7h13ihBKdo+70=");
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:FjyzfJydGoT0GJuUjZM2j8w/G/sLxdqykAcU7haZkec=");
		    ...
		    String dbquery_tDBInput_1 = "SELECT ecommerce_data.CustomerID,\n		ecommerce_data.Name,\n		ecommerce_data.Email,\n		ecommerce_data.Age,\n		ecommerce_data"
+".Gender,\n		ecommerce_data.Location,\n		ecommerce_data.ProductID,\n		ecommerce_data.Category,\n		ecommerce_data.Subcategory,"
+"\n		ecommerce_data.Price,\n		ecommerce_data.Weight,\n		ecommerce_data.Dimensions,\n		ecommerce_data.OrderID,\n		ecommerce_dat"
+"a.DateOrder,\n		ecommerce_data.TotalAmount,\n		ecommerce_data.ShippingMethod,\n		ecommerce_data.Status,\n		ecommerce_data.In"
+"ventoryID,\n		ecommerce_data.StockLevel,\n		ecommerce_data.RestockThreshold,\n		ecommerce_data.LastRestockDate,\n		ecommerce"
+"_data.WarehouseID,\n		ecommerce_data.LocationWarehouse,\n		ecommerce_data.Capacity,\n		ecommerce_data.SupplierID,\n		ecommer"
+"ce_data.Company,\n		ecommerce_data.LocationSupplier,\n		ecommerce_data.QualityScore\nFROM	ecommerce_data";
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(14).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.DateOrder = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.DateOrder = tmpContent_tDBInput_1;
                }
            } else {
                row1.DateOrder = null;
            }
...
if(out2 != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    if(out2.CustomerID == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(1, out2.CustomerID);
}

                    if(out2.Name == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, out2.Name);
}

                    if(out2.Email == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, out2.Email);
}

                    if(out2.Age == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(4, out2.Age);
}

                    if(out2.Gender == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5, out2.Gender);
}

                    if(out2.Location == null) {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(6, out2.Location);
}

                    if(out2.ProductID == null) {
pstmt_tDBOutput_2.setNull(7, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(7, out2.ProductID);
}

                    if(out2.Category == null) {
pstmt_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(8, out2.Category);
}

                    if(out2.Subcategory == null) {
pstmt_tDBOutput_2.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(9, out2.Subcategory);
}

                    if(out2.Price == null) {
pstmt_tDBOutput_2.setNull(10, java.sql.Types.FLOAT);
} else {pstmt_tDBOutput_2.setFloat(10, out2.Price);
}

                    if(out2.Weight == null) {
pstmt_tDBOutput_2.setNull(11, java.sql.Types.FLOAT);
} else {pstmt_tDBOutput_2.setFloat(11, out2.Weight);
}

                    if(out2.Dimensions == null) {
pstmt_tDBOutput_2.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(12, out2.Dimensions);
}

                    if(out2.OrderID == null) {
pstmt_tDBOutput_2.setNull(13, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(13, out2.OrderID);
}

                    if(out2.DateOrder != null) {
pstmt_tDBOutput_2.setTimestamp(14, new java.sql.Timestamp(out2.DateOrder.getTime()));
} else {
pstmt_tDBOutput_2.setNull(14, java.sql.Types.TIMESTAMP);
}

                    if(out2.TotalAmount == null) {
pstmt_tDBOutput_2.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(15, out2.TotalAmount);
}

                    if(out2.ShippingMethod == null) {
pstmt_tDBOutput_2.setNull(16, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(16, out2.ShippingMethod);
}

                    if(out2.Status == null) {
pstmt_tDBOutput_2.setNull(17, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(17, out2.Status);
}

                    if(out2.InventoryID == null) {
pstmt_tDBOutput_2.setNull(18, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(18, out2.InventoryID);
}

                    if(out2.StockLevel == null) {
pstmt_tDBOutput_2.setNull(19, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(19, out2.StockLevel);
}

                    if(out2.RestockThreshold == null) {
pstmt_tDBOutput_2.setNull(20, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(20, out2.RestockThreshold);
}

                    if(out2.LastRestockDate == null) {
pstmt_tDBOutput_2.setNull(21, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(21, out2.LastRestockDate);
}

                    if(out2.WarehouseID == null) {
pstmt_tDBOutput_2.setNull(22, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(22, out2.WarehouseID);
}

                    if(out2.LocationWarehouse == null) {
pstmt_tDBOutput_2.setNull(23, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(23, out2.LocationWarehouse);
}

                    if(out2.Capacity == null) {
pstmt_tDBOutput_2.setNull(24, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(24, out2.Capacity);
}

                    if(out2.SupplierID == null) {
pstmt_tDBOutput_2.setNull(25, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(25, out2.SupplierID);
}

                    if(out2.Company == null) {
pstmt_tDBOutput_2.setNull(26, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(26, out2.Company);
}

                    if(out2.LocationSupplier == null) {
pstmt_tDBOutput_2.setNull(27, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(27, out2.LocationSupplier);
}

                    if(out2.QualityScore == null) {
pstmt_tDBOutput_2.setNull(28, java.sql.Types.FLOAT);
} else {pstmt_tDBOutput_2.setFloat(28, out2.QualityScore);
}
			...
			for (String[] item_tRunJob_2 : childReturn_tRunJob_2) { 
				if(childJob_tRunJob_2.hastBufferOutputComponent() || true){
						...
						if(0 < item_tRunJob_2.length){				
			           			...
			           			row3.avgQualityScore = ParserUtils.parseTo_Float(item_tRunJob_2[0]);
			           		
		           		}else{
			           		row3.avgQualityScore = null;
		           		}
 ...
 */
	...
	if(operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
		...
		hash_tAggregateRow_1.put(operation_result_tAggregateRow_1, operation_result_tAggregateRow_1);
				...
				if(row3.avgQualityScore != null) { // G_OutMain_AggR_546
...
/************************************************************************************************
 *     242516 characters generated by Talend Open Studio for Data Integration 
 *     on the September 8, 2023 at 9:11:53 AM WEST
 ************************************************************************************************/